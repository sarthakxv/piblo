            ...
            <div className="mx-auto max-w-5xl">
                ...
                <section className="py-10 sm:py-16">
                    ...
                    <div className="mt-10 flex flex-wrap gap-3">
                        ...
                        <Button nativeButton={false} render={<Link href="/library" />} variant="outline" className="border-rule-strong bg-paper-raised px-5 text-graphite">Browse more lessons</Button>
                    </div>
                </section>
            </div>
        </main>
